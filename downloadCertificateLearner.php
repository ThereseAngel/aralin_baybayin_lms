...
<?php 
     ...
     $font_size_date = 10;
     $name = strtoupper( $data['learner_name']);
    $name_len = strlen( $data['learner_name']);
 ...
 ?>
    ...
    <input class="button" type="button" onClick="location.href='lessonLearner.php'" value="Go back"/>
