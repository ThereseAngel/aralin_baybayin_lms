...
<html lang="en">
  ...
  <body>
    ...
    <div class="progbar">
      ...
      <button class="button" id="startLesson" onclick="window.location.href='startlessonStudent.php'">Start Lesson</button><br><br>
      <?php
    ...
    if($row['student_status'] == "100")  {
      echo "<script> window.onload = function() {completeCert();}; </script>";
    ?>
      <div id="viewCert" style="display: none">
    <input class="certificate" type="button"  onClick="location.href='downloadCertificateStudent.php'" value="View Certificate"/>
  </div>
  <?php }
  ?>
    </div>
