...
<html lang="en">
  ...
  <body>  
    ...
    <div class="allLessons" id="allLessonscontainer">
      <div class="title-on-quizzes">Baybayin Quiz 3 Answers</div>
        <!-- Quiz container-->
        <?php
          $tableName1="quiz3";
    ...
    <input class="button" type="button"  onClick="location.href='addprogressLearner.php'" value="Go back to Lessons"/>
