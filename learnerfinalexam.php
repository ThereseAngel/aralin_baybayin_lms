...
<html lang="en">
  ...
  <body>  
    ...
    <div class="bump">
      <br>
      <form>
        <div class="title">Baybayin Final Quiz</div>
    ...
    <!--Store quiz 1 grade of learner in database-->
    <form action="" method="post">  
      <?php if($_SESSION['clicks']>15){ 
        ...
        @session_start();
        $userID = $_SESSION['userid'];
        $edit = mysqli_query($db, "UPDATE learner_progress SET finalexam_grade='$score' WHERE learner_id='".$_SESSION['userid']."'");
      ?> 
      <h2>Result</h2>
    ...
    <input class="button" type="button" onClick="location.href='learnerReviewFE.php'" value="Review Answers"/>
    <?php 
    } 
    ?>
    <?php  ?>
