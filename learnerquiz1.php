  ...
  <body>  
    ...
    <form action="" method="post">  
      <?php if($_SESSION['clicks']>10){ 
        ...
        @session_start();
        $userID = $_SESSION['userid'];
        $edit = mysqli_query($db, "UPDATE learner_progress SET q1_grade='$score' WHERE learner_id='".$_SESSION['userid']."'");
      ?> 
      <h2>Result</h2>
    ...
    <input class="button" type="button" onClick="location.href='learnerReview1.php'" value="Review Answers"/>
    <?php 
    } 
    ?>
    <?php  ?>
