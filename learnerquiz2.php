...
<html lang="en">
  ...
  <body>  
    ...
    <!--Store quiz 2 grade of learner in database-->
    <form action="" method="post">  
      <?php if($_SESSION['clicks']>10){ 
        ...
        @session_start();
        $userID = $_SESSION['userid'];
        $edit = mysqli_query($db, "UPDATE learner_progress SET q2_grade='$score' WHERE learner_id='".$_SESSION['userid']."'");
      ?> 
      <h2>Result</h2>
    ...
    <input class="button" type="button" onClick="location.href='learnerReview2.php'" value="Review Answers"/>
    <?php 
    } 
    ?>
    <?php  ?>
