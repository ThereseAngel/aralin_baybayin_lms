  ...
  <body>
    ...
    <nav>
      <div class="navbar">
        ...
        <div class="logo">
          <a href="homepageStudent.php">AralinBaybayin</a>
        </div>
        <div class="nav-links">
    ...
    <?php
      ...
      @session_start();
      $userID = $_SESSION['userid'];
      $userData = mysqli_query($db,"SELECT * from student_progress where student_id = '".$_SESSION['userid']."'");
      while($data = mysqli_fetch_array($userData)){
        $stats = $data['student_status'];
        if($stats == "10"){
    ...
    <div class="allLessons" id="allLessonscontainer">
      ...
      <div class="lesson-content" id="lesson1Content" name="lesson1Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton1" type="submit" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of Lesson 1-->
      ...
      <div class="lesson-content" id="lesson2Content" name="lesson2Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton2" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 2-->
      ...
      <div class="lesson-content" id="lesson3Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton3" onclick="location.href='studentquiz1.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 3-->
      ...
      <div class="lesson-content" id="quiz1Content">
        <h1>Quiz 1</h1>
        <div>
          <form method="POST" action="studentquiz1.php">
      ...
      <div class="lesson-content" id="lesson4Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton4" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 4-->
      ...
      <div class="lesson-content" id="lesson5Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton5" onclick="location.href='studentquiz2.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 5-->
      ...
      <div class="lesson-content" id="quiz2Content">
        <h1>Quiz 2</h1>
        <div>
          <form method="POST" action="studentquiz2.php">
      ...
      <div class="lesson-content" id="lesson6Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton6" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 6-->
      ...
      <div class="lesson-content" id="lesson7Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton7" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 7-->
      ...
      <div class="lesson-content" id="lesson8Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton8" onclick="location.href='studentquiz3.php'">Next</button>
        </div>
      </div>
      <!--End of lesson 8-->
      ...
      <div class="lesson-content" id="quiz3Content">
        <h1 >Quiz 3</h1>
        <div>
          <form method="POST" action="studentquiz3.php">
      ...
      <div class="lesson-content" id="lesson9Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton9" onclick="location.href='addprogressStudent.php'">Next</button>
        </div>
      </div>
      <!--End of Lesson 9-->
      ...
      <div class="lesson-content" id="lesson10Content">
        ...
        <div id="nextButton">
          <button class="button" id="nextButton10" onclick="location.href='studentfinalexam.php'">Next</button>
        </div>
      ...
      <div class="lesson-content" id="finalExamContent">
        <h1>Final Exam</h1>
        <div>
          <form method="POST" action="studentfinalexam.php">
