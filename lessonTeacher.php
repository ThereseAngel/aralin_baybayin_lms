...
<html lang="en">
  ...
  <body>
    ...
    <div class="sidebar" style="margin-top: -3%">
      ...
      <button id="lesson2" class="lessonButton">Lesson 2</button>
      <button id="lesson3" class="lessonButton">Lesson 3</button>
      <button id="quiz1" class="lessonButton">Quiz 1</button>
      <button id="lesson4" class="lessonButton">Lesson 4</button>
      <button id="lesson5" class="lessonButton">Lesson 5</button>
      <button id="quiz2" class="lessonButton">Quiz 2</button>
      <button id="lesson6" class="lessonButton">Lesson 6</button>
      <button id="lesson7" class="lessonButton">Lesson 7</button>
      <button id="lesson8" class="lessonButton">Lesson 8</button>
      <button id="quiz3" class="lessonButton">Quiz 3</button>
      <button id="lesson9" class="lessonButton">Lesson 9</button>
      <button id="lesson10" class="lessonButton">Lesson 10</button>
      <button id="finalExam" class="lessonButton">Final Exam</button>
    </div>
    ...
    <div class="allLessons" id="allLessonscontainer">
      ...
      <div class="lesson-content" id="quiz1Content">
        ...
        <div style="text-align: center">
          <form method="POST" action="teacherquiz1.php">
            <input class="button" type="submit" value="View Quiz 1 Answer Sheet" />
          </form>
        </div>
      </div>
      <!--End of quiz 1-->
      ...
      <div class="lesson-content" id="quiz2Content">
        <h1 style="text-align: center">Quiz 2</h1>
        <div style="text-align: center">
          <form method="POST" action="teacherquiz2.php">
            <input class="button" type="submit" value="View Quiz 2 Answer Sheet "/>
          </form>
        </div>
      </div>
      <!--End of quiz 2-->
      ...
      <div class="lesson-content" id="quiz3Content">
        <h1 style="text-align: center">Quiz 3</h1>
        <div style="text-align: center">
          <form method="POST" action="teacherquiz3.php">
            <input class="button" type="submit" value="View Quiz 3 Answer Sheet" />
          </form>
        </div>
      </div>
      <!--End of quiz 3-->
      ...
      <div class="lesson-content" id="finalExamContent">
        ...
        <div style="text-align: center">
          <form method="POST" action="teacherfinalexam.php">
            <input class="button" type="submit" value="View Final Exam Answer Sheet" />
          </form>
        </div>
      </div>
      <!--End of final exam-->
