...
<html lang="en">
  ...
  <body>  
    ...
    <div class="allLessons" id="allLessonscontainer">
      <div class="title-on-quizzes">Baybayin Final Exam Answers</div>
        <!-- Quiz container-->
        <?php
          $tableName1="finalexam";
    ...
    <input class="button" type="button"  onClick="location.href='downloadCertificateStudent.php'" value="View Certificate"/>
