...
<html lang="en">
  ...
  <body>  
    ...
    <div class="bump">
      <br>
      <form>
        <div class="title">Baybayin Quiz 2</div>
    ...
    <div class="baybayinquestion"  style= "text-align:center">
      <form action="" method="post">  
   			<table>
          <?php if(isset($c)) {   
            $fetchqry = "SELECT * FROM `quiz2` where id='$c'"; 
    ...
    <!--Store quiz 2 grade of student in database-->
    <form action="" method="post">  
      <?php if($_SESSION['clicks']>10){ 
        ...
        $score = 0;
          ...
          if($row3['ans']==$row3['userans']){
            ...
            @session_start();
            $userID = $_SESSION['userid'];
            $edit = mysqli_query($db, "UPDATE student_progress SET q2_grade='$score' WHERE student_id='".$_SESSION['userid']."'");
	        }
        }
      ?> 
       <h2>Result</h2>
    ...
    <input class="button" type="button" onClick="location.href='studentReview2.php'" value="Review Answers"/>
    <?php 
    } 
    ?>
    <?php  ?>
