...
<html lang="en">
  ...
  <body>  
    ...
    <div class="bump">
      <br>
      <form>
        <div class="title">Baybayin Quiz 3</div>
    ...
    <!--Store quiz 3 grade of student in database-->
    <form action="" method="post">  
      <?php if($_SESSION['clicks']>10){ 
        ...
        $score = 0;
          ...
          if($row3['ans']==$row3['userans']){
            ...
            @session_start();
            $userID = $_SESSION['userid'];
            $edit = mysqli_query($db, "UPDATE student_progress SET q3_grade='$score' WHERE student_id='".$_SESSION['userid']."'");
	        }
        }
      ?> 
      <h2>Result</h2>
    ...
    <input class="button" type="button" onClick="location.href='studentReview3.php'" value="Review Answers"/>
    <?php 
    } 
    ?>
    <?php  ?>
